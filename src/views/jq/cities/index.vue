...
<script>
import { listCities, getCities, delCities, addCities, updateCities } from "@/api/jq/cities"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('jq/cities/export', {
        ...this.queryParams
